...
class Chick(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        self.chickleft = scale(pygame.image.load('Assets/Images/chickleft.png').convert_alpha())
        self.chickright = scale(pygame.image.load('Assets/Images/chickright.png').convert_alpha())
        self.chickjumpright = scale(pygame.image.load('Assets/Images/chickjumpright.png').convert_alpha())
        self.chickjumpleft = scale(pygame.image.load('Assets/Images/chickjumpleft.png').convert_alpha())
        self.chickrunleft1 = scale(pygame.image.load('Assets/Images/chickrunleft1.png').convert_alpha())
        self.chickrunleft2 = scale(pygame.image.load('Assets/Images/chickrunleft2.png').convert_alpha())
        self.chickrunright1 = scale(pygame.image.load('Assets/Images/chickrunright1.png').convert_alpha())
        self.chickrunright2 = scale(pygame.image.load('Assets/Images/chickrunright2.png').convert_alpha())
        self.flyleft1 = scale(pygame.image.load('Assets/Images/chickflyleftst1.png').convert_alpha())
        self.flyleft2 = scale(pygame.image.load('Assets/Images/chickflyleftst2.png').convert_alpha())
        self.flyleft3 = scale(pygame.image.load('Assets/Images/chickflyleftst3.png').convert_alpha())
